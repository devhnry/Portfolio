	...
	return (
			<header className={`font-inter capitalize text-md text-paragraph-1 md:text-[1.0625rem]`}>
				<nav className={`flex justify-between items-start md:items-center`}>
					...
					<ul className={`flex flex-col gap-y-[0.3px] md:flex-row items-start md:items-center gap-x-2 sm:text-[17px] font-light leading-[1.35] md:text-[clamp(0.9375rem,2.1vw,1.175rem)]`}>
						{navItems.map((item, i) => {
							return (
